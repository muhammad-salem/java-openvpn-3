...
import org.openvpn.ovpn3.*;

import java.io.*;

public class VPNClient implements OpenVPNClientThread.EventReceiver {
	...
	public VPNClient(String config_text,
					 String username,
					 String password,
					 String proxyHost,
...
//		defineConfigWithProxy(proxyHost, proxyPort, proxyUsername,proxyPassword);
	...
	public VPNClient(String config_text, String username, String password) throws ConfigError, CredsUnspecifiedError {
		initClient(config_text, username, password, null, null, null, null);
	}

	public VPNClient(File config_file,
					 String username,
					 String password,
					 String proxyHost,
...
//		defineConfigWithProxy(proxyHost, proxyPort, proxyUsername,proxyPassword);
	...
	public VPNClient(File config_file, String username, String password) throws ConfigError, CredsUnspecifiedError, IOException{
	...
	public void initClient(String config_text, String username, String password,
		...
		config.setGoogleDnsFallback(true);
